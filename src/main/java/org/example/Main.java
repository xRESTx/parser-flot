    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int numberPage = 1; numberPage <= 2; numberPage++) {
            String[] task = new String[]{
                    ...
                    "vodohod"+ Integer.toString(table) +".txt"
            };
            tasks.add(task);
            table++;
        }
