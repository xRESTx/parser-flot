...
public class Parser_gama {
    public void Course(String url) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("cruises.txt", true))) {
            ...
            extractInfoAndCheckButtons(writer, webDriver);
    ...
    private void extractInfoAndCheckButtons(BufferedWriter writer, WebDriver webDriver) throws IOException, InterruptedException {
        // Считываем информацию с текущей страницы
    ...
    public static void main(String[] args) {
        Parser_gama parser = new Parser_gama();
        parser.Course("URL вашей страницы"); // замените на нужный URL
    }
}
